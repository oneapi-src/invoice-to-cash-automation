...
def invoke_inv_classification_inference(test_dataset_path, int8_model_path, inference_for_single_batch, inference_count):
    ...
    #model_saved_path="/home/azureuser/Validation/TradePromo_220922/quantized_model.pb"
    with tf.gfile.GFile(int8_model_path, "rb") as f:
...
if __name__ == "__main__":
    ...
    int8_model_path = str(FLAGS.int8_model_path)
    test_dataset_path = str(FLAGS.data_file_path)
    ...
    invoke_inv_classification_inference(test_dataset_path, int8_model_path, single_or_batch_inference, batch_size)
